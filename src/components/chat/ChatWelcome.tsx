...
export interface ConversationStarter {
  title: string;
  descriptor: string;
  /** Pre-written assistant message inserted as the first chat message. */
...
If typing feels hard, feel free to use the dictation feature and just yap away. Talk through your thoughts and I'll help interpret and shape them.
...
- What they're tired of, sceptical about, or struggling to solve
...
- Any expertise, lived experience, stories, or opinions that shape your brand
- Whether your focus right now is growth, authority, trust-building, or sales
...
- What the offer is and who it's designed for
